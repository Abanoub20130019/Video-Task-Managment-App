...
export default function Header() {
  ...
  return (
    <header className="bg-gradient-to-r from-white via-gray-50 to-white shadow-lg border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:flex items-center space-x-3 bg-white rounded-full px-3 py-1.5 shadow-sm border border-gray-100">
              <div className="relative">
                <div className="w-9 h-9 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center shadow-md ring-2 ring-white">
            ...
            <button
              onClick={() => signOut()}
              className="hidden sm:inline-flex items-center px-4 py-2 text-sm font-medium text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-red-500 hover:to-red-600 border border-gray-200 hover:border-transparent rounded-lg transition-all duration-300 shadow-sm hover:shadow-md"
            >
            ...
            <div className="lg:hidden">
              <button
                ...
                className="relative p-2 text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-gray-100 bg-gradient-to-b from-white to-gray-50 shadow-lg">
            ...
            <div className="px-4 py-4 border-t border-gray-100 bg-white">
              ...
              <button
                onClick={() => signOut()}
                className="mt-4 w-full flex items-center justify-center px-4 py-2.5 text-sm font-medium text-red-600 hover:text-white hover:bg-gradient-to-r hover:from-red-500 hover:to-red-600 border border-red-200 hover:border-transparent rounded-lg transition-all duration-300 shadow-sm hover:shadow-md"
              >
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
